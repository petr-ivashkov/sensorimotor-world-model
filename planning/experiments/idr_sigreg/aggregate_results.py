#!/usr/bin/env python3
"""Aggregate IDR+SIGReg planning metrics and summarize them by environment."""
        ...
        output.append(
            {
                ...
                "sigreg_weight": row["sigreg_weight"],
                "success_rate": str(
...
def main() -> None:
    ...
    summary_path = exp_dir / "combined_summary_results.csv"
