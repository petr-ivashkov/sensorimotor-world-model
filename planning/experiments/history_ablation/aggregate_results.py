#!/usr/bin/env python3
"""Aggregate history-ablation planning-eval metrics into one CSV table.

Adapted from planning_eval/aggregate_results.py; the manifest here carries the
extra (method, history) axes.
"""
