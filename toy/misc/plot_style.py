"""Shared Matplotlib styling for NeurIPS-style project figures."""
...
# NeurIPS 2026 text block: 5.5 in wide.
FULL_WIDTH = 5.5
...
_PAPER_STYLE = {
    ...
    # ------------------------------------------------------------------
    # Fonts
    # NeurIPS uses a Times-like 10 pt text style. Use a robust serif
    # fallback stack instead of hard-requiring Times New Roman.
    # ------------------------------------------------------------------
    "text.usetex": False,
    "font.family": "serif",
    "font.serif": [
